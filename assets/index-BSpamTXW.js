...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Ki,depthTest:!1,depthWrite:!1})}function pc(){return new an({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:qa(),fragmentShader:`
		...
		`,blending:Ki,depthTest:!1,depthWrite:!1})}function fc(){return new an({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:qa(),fragmentShader:`
...
#define LOW_PRECISION`),e}function hv(s){let e="SHADOWMAP_TYPE_BASIC";return s.shadowMapType===Fo?e="SHADOWMAP_TYPE_PCF":s.shadowMapType===yu?e="SHADOWMAP_TYPE_PCF_SOFT":s.shadowMapType===Ai&&(e="SHADOWMAP_TYPE_VSM"),e}function uv(s){let e="ENVMAP_TYPE_CUBE";if(s.envMap)switch(s.envMapMode){case Hn:case Vn:e="ENVMAP_TYPE_CUBE";break;case sr:e="ENVMAP_TYPE_CUBE_UV";break}return e}function dv(s){let e="ENVMAP_MODE_REFLECTION";if(s.envMap)switch(s.envMapMode){case Vn:e="ENVMAP_MODE_REFRACTION";break}return e}function pv(s){let e="ENVMAP_BLENDING_NONE";if(s.envMap)switch(s.combine){case aa:e="ENVMAP_BLENDING_MULTIPLY";break;case ju:e="ENVMAP_BLENDING_MIX";break;case Xu:e="ENVMAP_BLENDING_ADD";break}return e}function fv(s){const e=s.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,i=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:i,maxMip:t}}function mv(s,e,t,i){const n=s.getContext(),r=t.defines;let a=t.vertexShader,o=t.fragmentShader;const l=hv(t),c=uv(t),h=dv(t),u=pv(t),d=fv(t),p=iv(t),g=nv(r),v=n.createProgram();let f,m,_=t.glslVersion?"#version "+t.glslVersion+`
