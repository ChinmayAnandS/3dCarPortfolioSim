...
export default class Rampjump {
    ...
    private initRamp(): void {
        ...
        this.rampBody.addShape(new CANNON.Box(new CANNON.Vec3(width / 2, height / 2, depth / 2)));
        this.rampBody.position.set(this.rampPosition.x, this.rampPosition.y, this.rampPosition.z);
        this.rampBody.quaternion.setFromAxisAngle(new CANNON.Vec3(this.rampAngle.x, this.rampAngle.y, this.rampAngle.z), this.rampAngle.angle);
    ...
    private initLandingRamp(): void {
        ...
        this.rampBody.addShape(new CANNON.Box(new CANNON.Vec3(width / 2, height / 2, depth / 2)));
        this.rampBody.position.set(this.rampPosition.x, this.rampPosition.y, this.rampPosition.z + 25);
        this.rampBody.quaternion.setFromAxisAngle(new CANNON.Vec3(this.rampAngle.x, this.rampAngle.y, this.rampAngle.z), -this.rampAngle.angle);
        this.world.addBody(this.rampBody);
    }
}